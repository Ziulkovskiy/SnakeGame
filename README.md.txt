...
collecting food (or other objects), avoiding collision with its own tail and edges of the playing field. In some embodiments,
 ...
 which gradually complicates the game. The player controls the direction of movement of the snake's head (usually 4 directions:
 up, down, left, right), and the snake's tail follows. The player can not stop the movement of the snake.